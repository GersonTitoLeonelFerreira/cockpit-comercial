...
-- =========================================================
-- STEP 4: Recreate vw_sales_performance_by_owner (unchanged logic)
-- =========================================================
...
SELECT
  ...
  round(
    avg(EXTRACT(day FROM COALESCE(sc.won_at, now()) - sc.created_at)), 1
  )                                                    AS dias_medio_ciclo
FROM public.sales_cycles sc
...
-- =========================================================
-- STEP 5: Recreate vw_sales_monthly_analysis (unchanged logic)
-- =========================================================
...
-- =========================================================
-- STEP 6: Recreate vw_sales_lost_analysis (unchanged logic)
-- =========================================================
