-- Yolen Companion V2 - Fase 4 / PT4-C
-- Ingestão transacional e idempotente das mensagens capturadas.
--
-- Esta migration não conecta a extensão e não ativa o motor V2.
-- Ela cria somente a operação server-side que grava o ledger e avança
-- o cursor observado de forma atômica.
...
begin
  ...
  select cycle.owner_user_id
  into v_cycle_owner_id
