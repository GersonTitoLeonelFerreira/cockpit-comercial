-- ============================================================================
-- 088_allow_site_leads_without_document.sql
-- Formulários de site podem receber nome, telefone e e-mail sem CPF/CNPJ.
-- lead_profiles só é criado quando existe documento válido.
-- ============================================================================
