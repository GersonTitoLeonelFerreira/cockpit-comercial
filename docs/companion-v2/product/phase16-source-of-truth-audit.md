...
| `CommercialReading` (seller coaching — `improvement_points`/`seller_strengths`; method adherence) | **PARTIAL/FULL** — esses subtipos têm `evidence_message_ids`/`memory_ids` exigidos pelo normalizador | ver `normalizeCommercialReading`, linhas #33/#34/#17 da matriz |
