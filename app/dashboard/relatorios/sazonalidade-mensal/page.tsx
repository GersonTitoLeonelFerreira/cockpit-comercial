...
function MonthRow({
  ...
  row: MonthlySeasonalityRow
  bestRevenueMonth: number | null
  bestActionMonth: number | null
}) {
  const isBestRevenue =
    bestRevenueMonth === row.month && row.faturamento > 0

  const isBestAction =
    bestActionMonth === row.month && row.acoes_comerciais > 0
  ...
  return (
    ...
    >
      <td style={{ padding: '14px 18px' }}>
        ...
        >
          {row.anos_com_dados} ano(s) com dados
        </div>
      </td>
...
export default function SazonalidadeMensalRelatorioPg() {
  ...
  const [summary, setSummary] =
    React.useState<MonthlySeasonalitySummary | null>(null)
      ...
      try {
        ...
        if (!cancelled) {
          setDataError(
            getErrorMessage(
              cause,
              'Erro ao buscar os dados de sazonalidade mensal.',
            ),
          )
        }
      } finally {
  ...
  if (loading) {
    return (
      ...
      >
        Carregando Sazonalidade Mensal...
      </div>
    )
  }
    ...
    >
      <div style={{ margin: '0 auto', maxWidth: 1200 }}>
        ...
        <header style={{ marginBottom: 28 }}>
          ...
          >
            Leitura histórica por mês do ano, consolidando janeiro contra janeiro,
            fevereiro contra fevereiro e assim por diante.
          </p>
        </header>
        ...
        {summary ? (
          <>
            ...
            <section style={{ marginBottom: 28 }}>
              <SectionLabel>Destaques Sazonais</SectionLabel>
              ...
              >
                ...
                <HighlightCard
                  ...
                  value={
                    summary.melhor_mes_ganhos
                      ? `${summary.melhor_mes_ganhos.ganhos} venda(s)`
                      : '—'
                  }
                  description={
                    summary.melhor_mes_ganhos
                ...
                <HighlightCard
                  ...
                  name={summary.melhor_mes_acoes?.month_label ?? null}
                  value={
                    summary.melhor_mes_acoes
                      ? `${summary.melhor_mes_acoes.acoes_comerciais} ação(ões)`
                      : '—'
                  }
                ...
                <HighlightCard
                  label="Maior Avanço"
                  name={summary.melhor_mes_avancos?.month_label ?? null}
                  value={
                    summary.melhor_mes_avancos
                      ? `${summary.melhor_mes_avancos.avancos} avanço(s)`
                      : '—'
                  }
                ...
                <HighlightCard
                  ...
                  description={
                    summary.melhor_mes_ticket
                      ? `Base de ${summary.melhor_mes_ticket.ganhos} vendas ganhas`
                      : 'Exige no mínimo três vendas no mesmo mês.'
                  }
                />
              </div>
            </section>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Consolidação dos registros do mesmo mês em anos diferentes.
                  </p>
                </div>
                ...
                >
                  {summary.anos_no_periodo} ano(s) no recorte
                </div>
              </div>
                  ...
                  <tbody>
                    {summary.rows.map((row) => (
                      <MonthRow
                        ...
                        row={row}
                        bestRevenueMonth={
                          summary.melhor_mes_faturamento?.month ?? null
                        }
                        bestActionMonth={
                          summary.melhor_mes_acoes?.month ?? null
                        }
                      />
                    ))}
                  </tbody>
            ...
            >
              ...
              >
                ...
                <div>
                  <div style={fieldLabelStyle}>Meses no Recorte</div>
                  <div
                    style={{
                      color: DS.textPrimary,
                      fontSize: 13,
            ...
            >
              ...
              >
                Este é um relatório de sazonalidade acumulada. Leia a coluna
                “Anos” antes de comparar os meses. Quanto mais anos com dados,
                mais confiável é o padrão identificado.
              </div>
            </section>
          </>
        ) : null}
