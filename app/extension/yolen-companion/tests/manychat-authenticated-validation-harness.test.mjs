...
test('bundle diagnóstico contém a cadeia completa na ordem de dependência', () => {
  assert.deepEqual(SOURCE_FILES, [
    ...
    'src/manychat-audio-source-stability.js',
    'src/manychat-audio-accessibility.js',
    'src/manychat-audio-transcription-contract.js',
  ...
  assert.ok(
    bundle.indexOf('src/manychat-audio-source.js') <
      bundle.indexOf('src/manychat-audio-source-stability.js'),
  )
  assert.ok(
    bundle.indexOf('src/manychat-audio-source-stability.js') <
      bundle.indexOf('src/manychat-audio-accessibility.js'),
  )
  assert.ok(
    bundle.indexOf('src/manychat-audio-accessibility.js') <
      bundle.indexOf('src/manychat-audio-transcription-contract.js'),
  )
  assert.ok(
