  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerInner}>
        ...
        {navigation.length > 0 ? <nav className={styles.desktopNav} aria-label="Navegação principal">
          {navigation.map((item) => (
        ...
        <div className={styles.headerActions} style={navigation.length === 0 ? { marginLeft: 'auto' } : undefined}>
